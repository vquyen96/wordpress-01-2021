...
function woo_customize_general_admin_notice(){
         ...
         $msg = sprintf('<div data-dismissible="disable-done-notice-forever" class="notice notice-info" >
				...
				esc_html__('Storefront Pro Modern Theme is Here with more features and Security Updates.', 'woo-customize'),
				esc_url("admin.php?page=woo-customize/woo-customize.php"),
...
if ( isset( $_GET['woo_customize_notice_dismissed'] ) ){
	update_option('woo_customize_notice', -1);
}

global $pagenow;
if($pagenow == 'themes.php' || $pagenow == 'index.php'  || $pagenow == 'plugins.php' || $pagenow == 'options-general.php'){
	$woo_customize_notice = get_option('woo_customize_notice', 1);	
	if (($woo_customize_notice > 0 || $woo_customize_notice == '') ){
