...
?></div>
                        <div class="desc"><?php 
esc_html_e( 'Category Banner Management for Woocommerce plugin that allows you to manage checkout, product and category wise banners in your WooCommerce store.', 'woo-banner-management' );
?></div>
                    </div>
                </div>
