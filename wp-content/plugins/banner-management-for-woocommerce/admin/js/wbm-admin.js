jQuery(document).ready(function ($) {
    ...
    $('.wbm_banner_detail_page_single_upload_file_button').live('click', function (event) {
        var fileFrame;
        var attachment;
        event.preventDefault();
    ...
    if ( "true" === wbmAdminVars.can_use_premium_code || true === wbmAdminVars.can_use_premium_code ) {
        ...
        $('.wbm_banner_detail_page_upload_file_button').live('click', function (event) {
            var fileFrame;
            var attachment;
            ...
            fileFrame.on('select', function () {
                ...
                $.each(attachment, function (key, value) {
                    ...
                    $('<img />', {
                        'class': 'wbm_banner_detail_page_cat_banner_img_admin banner_banner_detail_image_' + imageId,
                        'src': value.url
                    }).appendTo(td1);
                    $('<input />', {
                        'type': 'text',
                    ...
                    trTag = $('<tr />', {'id': 'banner_banner_detail_' + imageId, 'class': 'banner_banner_detail_dynamic_div'});
                    $(td1).appendTo(trTag);
                    $(td2).appendTo(trTag);
                    $(td3).appendTo(trTag);
...
if ( "true" === wbmAdminVars.can_use_premium_code || true === wbmAdminVars.can_use_premium_code ) {
    ...
    $('.wbm_banner_detail_page_remove_single_file').live('click', function (event) {
    ...
    if ( "true" === wbmAdminVars.can_use_premium_code || true === wbmAdminVars.can_use_premium_code ) {
        ...
        $('.banner_detail-single-image-delete').live('click', function (event) {
            var imageId;
            if (confirm(wbmAdminVars.alert)) {
                imageId = $(this).attr('id');
